...
# Lexer para la gramatica de punteros (LALR vs SLR)

globals().setdefault('ASSIGN', 'ASSIGN')
globals().setdefault('ID', 'ID')
globals().setdefault('STAR', 'STAR')

DFA_TRANSITIONS = {0: {'C': 2, 'a': 2, 'r': 2, '*': 4, 'V': 2, 'K': 2, 'y': 2, 'i': 2, '\t': 1, '\r': 1, 'X': 2, 'g': 2, 'R': 2, 'm': 2, 'D': 2, 'U': 2, 'q': 2, 'W': 2, 'c': 2, 'N': 2, 'p': 2, 'Q': 2, 'x': 2, 'j': 2, 'f': 2, 'k': 2, 's': 2, 'd': 2, 'h': 2, 'z': 2, 'B': 2, 'o': 2, 'G': 2, ' ': 1, '\n': 1, 'J': 2, 'L': 2, 'P': 2, 't': 2, '=': 3, 'e': 2, 'T': 2, 'w': 2, 'F': 2, 'n': 2, 'l': 2, 'O': 2, 'b': 2, 'v': 2, 'S': 2, 'M': 2, 'I': 2, 'E': 2, 'Y': 2, 'A': 2, 'u': 2, 'Z': 2, 'H': 2}, 1: {'\t': 1, '\r': 1, ' ': 1, '\n': 1}, 2: {'1': 2, 'C': 2, 'a': 2, 'r': 2, 'V': 2, 'K': 2, 'y': 2, 'i': 2, '4': 2, 'X': 2, 'g': 2, 'R': 2, 'm': 2, 'D': 2, 'U': 2, '6': 2, 'q': 2, 'W': 2, 'c': 2, 'N': 2, 'p': 2, 'Q': 2, 'x': 2, '9': 2, 'j': 2, 'f': 2, 'k': 2, 's': 2, '2': 2, 'd': 2, 'h': 2, 'z': 2, 'B': 2, 'o': 2, 'G': 2, 'J': 2, 'L': 2, 'P': 2, 't': 2, '5': 2, 'e': 2, 'T': 2, 'w': 2, 'F': 2, 'n': 2, 'l': 2, 'O': 2, 'b': 2, 'v': 2, 'S': 2, 'M': 2, 'I': 2, '0': 2, 'E': 2, '3': 2, 'Y': 2, 'A': 2, 'u': 2, '8': 2, 'Z': 2, 'H': 2, '7': 2}, 3: {}, 4: {}}
DFA_ACCEPTS = {1: 0, 2: 1, 3: 2, 4: 3}
DFA_METHOD = 'direct'
ACTIONS = [{'kind': 'skip', 'token_name': None, 'raw': 'return lexbuf', 'argument': None}, {'kind': 'return_name', 'token_name': 'ID', 'raw': 'return ID', 'argument': None}, {'kind': 'return_name', 'token_name': 'ASSIGN', 'raw': 'return ASSIGN', 'argument': None}, {'kind': 'return_name', 'token_name': 'STAR', 'raw': 'return STAR', 'argument': None}]
